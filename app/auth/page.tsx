...
export default function AuthPage() {
  ...
  const submit = async (event: FormEvent) => {
    ...
    if (!supabaseConfigured || !supabase) { setMessageTone("error"); setMessage("Chưa cấu hình Supabase. Hãy điền NEXT_PUBLIC_SUPABASE_URL và NEXT_PUBLIC_SUPABASE_ANON_KEY trong Vercel."); return; }
    setBusy(true);
